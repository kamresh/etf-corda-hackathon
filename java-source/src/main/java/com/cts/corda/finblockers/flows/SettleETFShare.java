...
public class SettleETFShare {
    ...
    public static class Initiator extends ETFShareBaseFlow {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            final StateAndRef<ETFShareState> obligationToSettle = getObligationByLinearId(linearId);
            final ETFShareState inputObligation = obligationToSettle.getState().getData();
            ...
            if (!borrowerIdentity.equals(getOurIdentity())) {
                throw new FlowException("Settle ETFShareState flow must be initiated by the borrower.");
            }
            ...
            final Command settleCommand = new Command<>(new ETFCreationContract.Commands.Settle(), requiredSigners);
            ...
            if (amountRemaining.getQuantity() > 0) {
                ETFShareState outputObligation = inputObligation.pay(amount);
                builder.addOutputState(outputObligation, ETFCreationContract.OBLIGATION_CONTRACT_ID);
            }
