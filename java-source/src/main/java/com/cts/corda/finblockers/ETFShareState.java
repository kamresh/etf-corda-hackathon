package com.cts.corda.finblockers;
...
public class ETFShareState implements LinearState {
    ...
    public ETFShareState(Amount<Currency> amount, AbstractParty lender, AbstractParty borrower, Amount<Currency> paid, UniqueIdentifier linearId) {
        this.amount = amount;
        this.lender = lender;
    ...
    public ETFShareState(Amount<Currency> amount, AbstractParty lender, AbstractParty borrower, Amount<Currency> paid) {
        this.amount = amount;
        this.lender = lender;
        this.borrower = borrower;
        this.paid = paid;
    ...
    public ETFShareState(Amount<Currency> amount, AbstractParty lender, AbstractParty borrower) {
        this.amount = amount;
        this.lender = lender;
        this.borrower = borrower;
    ...
    public ETFShareState pay(Amount<Currency> amountToPay) {
        return new ETFShareState(
                this.amount,
                this.lender,
                this.borrower,
    ...
    public ETFShareState withNewLender(AbstractParty newLender) {
        return new ETFShareState(this.amount, newLender, this.borrower, this.paid, this.linearId);
    }

    public ETFShareState withoutLender() {
        return new ETFShareState(this.amount, NullKeys.INSTANCE.getNULL_PARTY(), this.borrower, this.paid, this.linearId);
    }
    ...
    public String toString() {
        ...
        return String.format("ETFShareState(%s): %s owes %s %s and has paid %s so far.",
                this.linearId, borrowerString, lenderString, this.amount, this.paid);
    }

    @Override
    public boolean equals(Object obj) {
        if (!(obj instanceof ETFShareState)) {
            return false;
        }
        ETFShareState other = (ETFShareState) obj;
