...
public class ETFShareObligation {
    @InitiatingFlow
    @StartableByRPC
    public static class Initiator extends ETFShareBaseFlow {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            final ETFShareState obligation = createObligation();
            ...
            final TransactionBuilder utx = new TransactionBuilder(getFirstNotary())
                    .addOutputState(obligation, ETFCreationContract.OBLIGATION_CONTRACT_ID)
                    .addCommand(new ETFCreationContract.Commands.Issue(), requiredSigners)
        ...
        @Suspendable
        private ETFShareState createObligation() throws FlowException {
            if (anonymous) {
                ...
                return new ETFShareState(amount, anonymousLender, anonymousMe);
            } else {
                return new ETFShareState(amount, lender, getOurIdentity());
            }
        }
    }
