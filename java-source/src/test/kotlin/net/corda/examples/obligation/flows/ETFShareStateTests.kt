 ...
 */
abstract class ETFShareStateTests {
    ...
    @org.junit.Before
    fun setup() {
        setCordappPackages("com.cts.corda.finblockers", "net.corda.finance")
        ...
        nodes.partyNodes.forEach {
            it.registerInitiatedFlow(ETFShareObligation.Responder::class.java)
            it.registerInitiatedFlow(TransferETFShare.Responder::class.java)
        }
    }
    ...
    protected fun issueObligation(borrower: net.corda.node.internal.StartedNode<MockNetwork.MockNode>,
        ...
        val flow = ETFShareObligation.Initiator(amount, lenderIdentity, anonymous)
    ...
    protected fun transferObligation(linearId: net.corda.core.contracts.UniqueIdentifier,
        ...
        val flow = TransferETFShare.Initiator(linearId, newLenderIdentity, anonymous)
    ...
    protected fun settleObligation(linearId: net.corda.core.contracts.UniqueIdentifier,
        ...
        val flow = SettleETFShare.Initiator(linearId, amount, anonymous)
        return borrower.services.startFlow(flow).resultFuture.getOrThrow()
    }
